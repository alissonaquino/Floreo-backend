/*
  ...
  - The values [HUMIDITY,LUMINOSITY] on the enum `SensorType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SensorType_new" AS ENUM ('HUMIDITY_AIR', 'HUMIDITY_SOIL', 'TEMPERATURE', 'LUMINOSITY_1', 'LUMINOSITY_2', 'LUMINOSITY_3', 'LUMINOSITY_4', 'RELAY_STATE');
